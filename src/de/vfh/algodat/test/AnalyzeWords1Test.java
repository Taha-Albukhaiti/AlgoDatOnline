...
public class AnalyzeWords1Test {
	...
	@Test
	public void testDistance9() throws IOException {
		AnalyzeWords1 aw = new AnalyzeWords1("file:blatest.txt");
		assertEquals("blablabla existiert in blatest.txt nur einmal, blabla davor!", Integer.MAX_VALUE, aw.distance("blablabla", "blablabla"));
	}
